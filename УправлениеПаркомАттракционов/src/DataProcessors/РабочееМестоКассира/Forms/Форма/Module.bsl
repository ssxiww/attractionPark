...
&НаКлиенте
 ...
 Процедура СписокНоменклатурыНачалоПеретаскивания(Элемент, ПараметрыПеретаскивания, Выполнение)
 	...
 	Значение = ЗначениеПеретаксиванияТовара(ДанныеСтроки);
 ...
 Процедура ПозицииПродажиПеретаскивание(Элемент, ПараметрыПеретаскивания, СтандартнаяОбработка, Строка, Поле)
 	...
 	Значение = ПараметрыПеретаскивания.Значение;//см.ЗначениеПеретаксиванияТовара
 ...
 Процедура ЗаполнитьДекорациюБаллыКлиента()
 	...
 	ЧастиФорматированнойСтроки = Новый Массив; //Массим из Строка, ФорматированнаяСтрока
 ...
 // * Цена - Число
&НаКлиенте
Функция ЗначениеПеретаксиванияТовара(ДанныеСтроки)
	Перем Значение;
